 ...
 */
module.exports.Component = AFRAME.registerComponent('gearvr-controler', {
    schema: {
    ...
    bindMethods: function () {
        this.onModelLoaded = AFRAME.utils.bind(this.onModelLoaded, this);
        this.onControllersUpdate = AFRAME.utils.bind(this.onControllersUpdate, this);
        this.checkIfControllerPresent = AFRAME.utils.bind(this.checkIfControllerPresent, this);
        this.removeControllersUpdateListener = AFRAME.utils.bind(this.removeControllersUpdateListener, this);
        this.onAxisMoved = AFRAME.utils.bind(this.onAxisMoved, this);
        this.onGamepadConnectionEvent = AFRAME.utils.bind(this.onGamepadConnectionEvent, this);
    },
    ...
    init: function () {
        ...
        this.bindMethods();
        this.checkControllerPresentAndSetup = AFRAME.checkControllerPresentAndSetup; // to allow mock
        this.emitIfAxesChanged = AFRAME.emitIfAxesChanged; // to allow mock
    },
